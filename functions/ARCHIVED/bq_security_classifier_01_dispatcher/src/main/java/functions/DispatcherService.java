...
public class DispatcherService {
    ...
    public void execute() throws IOException {
        ...
        logInfoWithTracker(String.format("will scan based on the given scope %s", getBqScanScopeAsStr()), runId);
    ...
    public void processProjects () throws IOException {
        logInfoWithTracker(String.format("Will process projects %s", projectIncludeList), runId);
